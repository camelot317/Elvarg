...
public class RangedData {
	...
	public enum RangedWeaponData {
		...
		BALLISTA(new int[]{19478, 19481}, new AmmunitionData[] {AmmunitionData.BRONZE_JAVELIN, AmmunitionData.IRON_JAVELIN, AmmunitionData.STEEL_JAVELIN, AmmunitionData.MITHRIL_JAVELIN, AmmunitionData.ADAMANT_JAVELIN, AmmunitionData.RUNE_JAVELIN}, RangedWeaponType.BALLISTA),
	...
	public enum AmmunitionData {
		...
		BRONZE_ARROW(882, 19, 10, 3, 44, 7, 43, 31),
		IRON_ARROW(884, 18, 9, 3, 44, 10, 43, 31),
		STEEL_ARROW(886, 20, 11, 3, 44, 16, 43, 31),
		MITHRIL_ARROW(888, 21, 12, 3, 44, 22, 43, 31),
		ADAMANT_ARROW(890, 22, 13, 3, 44, 31, 43, 31),
		RUNE_ARROW(892, 24, 15, 3, 44, 50, 43, 31),
		ICE_ARROW(78, 25, 16, 3, 44, 58, 34, 31),
		BROAD_ARROW(4160, 20, 11, 3, 44, 58, 43, 31),
		DRAGON_ARROW(11212, 1111, 1120, 3, 44, 65, 43, 31),

		BRONZE_BOLT(877, -1, 27, 3, 44, 13, 43, 31),
		OPAL_BOLT(879, -1, 27, 3, 44, 20, 43, 31),
		ENCHANTED_OPAL_BOLT(9236, -1, 27, 3, 44, 20, 43, 31),
		IRON_BOLT(9140, -1, 27, 3, 44, 28, 43, 31),
		JADE_BOLT(9335, -1, 27, 3, 44, 31, 43, 31),
		ENCHANTED_JADE_BOLT(9237, -1, 27, 3, 44, 31, 43, 31),
		STEEL_BOLT(9141, -1, 27, 3, 44, 35, 43, 31),
		PEARL_BOLT(880, -1, 27, 3, 44, 38, 43, 31),
		ENCHANTED_PEARL_BOLT(9238, -1, 27, 3, 44, 38, 43, 31),
		MITHRIL_BOLT(9142, -1, 27, 3, 44, 40, 43, 31),
		TOPAZ_BOLT(9336, -1, 27, 3, 44, 50, 43, 31),
		ENCHANTED_TOPAZ_BOLT(9239, -1, 27, 3, 44, 50, 43, 31),
		ADAMANT_BOLT(9143, -1, 27, 3, 44, 60, 43, 31),
		SAPPHIRE_BOLT(9337, -1, 27, 3, 44, 65, 43, 31),
		ENCHANTED_SAPPHIRE_BOLT(9240, -1, 27, 3, 44, 65, 43, 31),
		EMERALD_BOLT(9338, -1, 27, 3, 44, 70, 43, 31),
		ENCHANTED_EMERALD_BOLT(9241, -1, 27, 3, 44, 70, 43, 31),
		RUBY_BOLT(9339, -1, 27, 3, 44, 75, 43, 31),
		ENCHANTED_RUBY_BOLT(9242, -1, 27, 3, 44, 75, 43, 31),
		RUNITE_BOLT(9144, -1, 27, 3, 44, 84, 43, 31),
		BROAD_BOLT(13280, -1, 27, 3, 44, 88, 43, 31),
		DIAMOND_BOLT(9340, -1, 27, 3, 44, 88, 43, 31),
		ENCHANTED_DIAMOND_BOLT(9243, -1, 27, 3, 44, 88, 43, 31),
		ONYX_BOLT(9342, -1, 27, 3, 44, 90, 43, 31),
		ENCHANTED_ONYX_BOLT(9245, -1, 27, 3, 44, 90, 43, 31),
		DRAGON_BOLT(9341, -1, 27, 3, 44, 90, 43, 31),
		ENCHANTED_DRAGON_BOLT(9244, -1, 27, 3, 44, 90, 43, 31),

		BRONZE_DART(806, 1234, 226, 4, 33, 2, 45, 37),
		IRON_DART(807, 1235, 227, 4, 33, 5, 45, 37),
		STEEL_DART(808, 1236, 228, 4, 33, 8, 45, 37),
		MITHRIL_DART(809, 1238, 229, 4, 33, 10, 45, 37),
		ADAMANT_DART(810, 1239, 230, 4, 33, 15, 45, 37),
		RUNE_DART(811, 1240, 231, 4, 33, 20, 45, 37),
		DRAGON_DART(11230, 1123, 226, 4, 33, 25, 49, 37),

		BRONZE_KNIFE(864, 219, 212, 4, 33, 8, 45, 37),
		BRONZE_KNIFE_P1(870, 219, 212, 4, 33, 8, 45, 37),
		BRONZE_KNIFE_P2(5654, 219, 212, 4, 33, 8, 45, 37),
		BRONZE_KNIFE_P3(5661, 219, 212, 4, 33, 8, 45, 37),
		
		IRON_KNIFE(863, 220, 213, 4, 33, 12, 45, 37),
		IRON_KNIFE_P1(871, 220, 213, 4, 33, 12, 45, 37),
		IRON_KNIFE_P2(5655, 220, 213, 4, 33, 12, 45, 37),
		IRON_KNIFE_P3(5662, 220, 213, 4, 33, 12, 45, 37),
		
		STEEL_KNIFE(865, 221, 214, 4, 33, 15, 45, 37),
		STEEL_KNIFE_P1(872, 221, 214, 4, 33, 15, 45, 37),
		STEEL_KNIFE_P2(5656, 221, 214, 4, 33, 15, 45, 37),
		STEEL_KNIFE_P3(5663, 221, 214, 4, 33, 15, 45, 37),
				
		BLACK_KNIFE(869, 222, 215, 4, 33, 17, 45, 37),
		BLACK_KNIFE_P1(874, 222, 215, 4, 33, 17, 45, 37),
		BLACK_KNIFE_P2(5658, 222, 215, 4, 33, 17, 45, 37),
		BLACK_KNIFE_P3(5665, 222, 215, 4, 33, 17, 45, 37),
		
		MITHRIL_KNIFE(866, 223, 215, 4, 33, 19, 45, 37),
		MITHRIL_KNIFE_P1(873, 223, 215, 4, 33, 19, 45, 37),
		MITHRIL_KNIFE_P2(5657, 223, 215, 4, 33, 19, 45, 37),
		MITHRIL_KNIFE_P3(5664, 223, 215, 4, 33, 19, 45, 37),
		
		ADAMANT_KNIFE(867, 224, 217, 4, 33, 24, 45, 37),
		ADAMANT_KNIFE_P1(875, 224, 217, 4, 33, 24, 45, 37),
		ADAMANT_KNIFE_P2(5659, 224, 217, 4, 33, 24, 45, 37),
		ADAMANT_KNIFE_P3(5666, 224, 217, 4, 33, 24, 45, 37),
		
		RUNE_KNIFE(868, 225, 218, 4, 33, 30, 48, 37),
		RUNE_KNIFE_P1(876, 225, 218, 4, 33, 30, 48, 37),
		RUNE_KNIFE_P2(5660, 225, 218, 4, 33, 30, 48, 37),
		RUNE_KNIFE_P3(5667, 225, 218, 4, 33, 30, 48, 37),
		
		BRONZE_THROWNAXE(800, 43, 36, 3, 44, 7, 43, 31),
		IRON_THROWNAXE(801, 42, 35, 3, 44, 9, 43, 31),
		STEEL_THROWNAXE(802, 44, 37, 3, 44, 11, 43, 31),
		MITHRIL_THROWNAXE(803, 45, 38, 3, 44, 13, 43, 31),
		ADAMANT_THROWNAXE(804, 46, 39, 3, 44, 15, 43, 31),
		RUNE_THROWNAXE(805, 48, 41, 3, 44, 17, 43, 31),

		BRONZE_JAVELIN(825, 206, 200, 2, 40, 7, 45, 37),
		IRON_JAVELIN(826, 207, 201, 2, 40, 9, 45, 37),
		STEEL_JAVELIN(827, 208, 202, 2, 40, 11, 45, 37),
		MITHRIL_JAVELIN(828, 209, 203, 2, 40, 13, 45, 37),
		ADAMANT_JAVELIN(829, 210, 204, 2, 40, 15, 45, 37),
		RUNE_JAVELIN(830, 211, 205, 2, 40, 17, 45, 37),

		TOKTZ_XIL_UL(6522, -1, 442, 2, 40, 58, 51, 37),
		
		CHINCHOMPA(10033, -1, -1, 17, 8, 50, 45, 37),
		RED_CHINCHOMPA(10034, -1, -1, 17, 8, 80, 45, 37),
		...
		AmmunitionData(int itemId, int startGfxId, int projectileId, int projectileSpeed, int projectileDelay, int strength, int startHeight, int endHeight) {
			this.itemId = itemId;
	...
	public static boolean checkAmmo(Player player) {
		...
		if(rangedWeapon == RangedWeaponData.DARK_BOW || rangedWeapon == RangedWeaponData.MAGIC_SHORTBOW && player.isSpecialActivated()) {
			requiredArrows = 2;
		}
	...
	public static void decrementAmmo(Player player, Position pos) {
		...
		int slot = player.getCombat().getWeapon() == WeaponInterface.SHORTBOW || player.getCombat().getWeapon() == WeaponInterface.LONGBOW 
				|| player.getCombat().getWeapon() == WeaponInterface.CROSSBOW ? Equipment.AMMUNITION_SLOT : Equipment.WEAPON_SLOT;
