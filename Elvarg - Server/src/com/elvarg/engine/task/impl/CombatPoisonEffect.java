...
public class CombatPoisonEffect extends Task {
	...
	public void execute() {
		...
		entity.dealDamage(new HitDamage(entity.getAndDecrementPoisonDamage(), HitMask.GREEN));
	}
	...
	public static final class CombatPoisonData {
		...
		public static void init() {
			...
			types.put(12926, PoisonType.SUPER);
		}
