...
public final class LoginResponses {
	...
	public static final int evaulate(Player player, LoginDetailsMessage msg) {
		...
		if(World.getPlayerByName(player.getUsername()) != null || World.getLogoutQueue().contains(player) || World.getLoginQueue().contains(player) 
				|| World.getPlayerAddQueue().contains(player) || World.getPlayerRemoveQueue().contains(player)) {
