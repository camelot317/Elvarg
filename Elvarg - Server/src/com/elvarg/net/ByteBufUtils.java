...
public final class ByteBufUtils {
	 ...
	 * reached.
	 * <p>
	 * We use a {@link ByteArrayOutputStream} as it is self expanding. We don't
	 * want to waste precious time determining a fixed length for the
	 * {@code String}.
	 * </p>
	 * 
	 * @param buffer
	 *            The ByteBuffer to read from.
	 * @param terminator
	 *            The terminator which denotes when to stop reading.
