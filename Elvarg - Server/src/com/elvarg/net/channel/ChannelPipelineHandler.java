...
public class ChannelPipelineHandler extends ChannelInitializer<SocketChannel> {
	...
	/**
	 * The part of the pipeline that limits connections, and checks for any
	 * banned hosts.
	 */
	private final ChannelFilter FILTER = new ChannelFilter();

	/**
	 * The part of the pipeline that handles exceptions caught, channels being
	 * read, in-active channels, and channel triggered events.
	 */
